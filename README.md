...
1. 从 [Releases](https://github.com/openRin/Rin/releases) 下载最新版本的 APK 文件
2. 在手机上允许安装未知来源应用
3. 点击 APK 文件进行安装
...
1. 在登录页面输入你的 GitHub 账户信息
2. 完成 GitHub OAuth 认证
3. 登录成功后自动跳转到首页

### 文章浏览

- **首页**：展示文章列表，支持下拉刷新和分页加载
- **时间轴模式**：点击切换按钮可查看时间轴形式的内容
- **文章操作**：点击文章进入详情，长按可进行编辑/删除/分享
